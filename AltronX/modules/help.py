...
PythonHelp = f"⚡️ ​𝐑𝐈𝐒𝐇𝐀𝐍𝐓 𝗦𝗣𝗔𝗠 𝙃𝗘𝗟𝗣 𝙈𝗘𝗡𝗨 ⚡️\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @OY_BABY**"
...
async def help(event):
    if event.sender_id in SUDO_USERS:
       await event.client.send_file(event.chat_id,
           ...
           [    
            Button.url("⚡️ ᴄʜᴀɴɴᴇʟ ⚡️", "https://t.me/GROUPPPPPPPHELP"),
            Button.url("⚡️ sᴜᴘᴘᴏʀᴛ ⚡️", "https://t.me/GROUPPPPPPPHELP")
           ],
           ],
           )
...
async def helpback(event):
   if event.query.user_id in SUDO_USERS:    
      await event.edit(
        ...
        await event.answer("𝗣ᴀʜʟᴇ 𝗝ᴀᴀᴋᴇ 𝗣ᴀᴘᴀ 𝗕ᴏʟ ⚡️𝐑𝐈𝐒𝐇𝐀𝐍𝐓⚡️ 𝗞ᴏ 𝗪ᴏ 𝗧ᴜᴍʜᴇ 𝗦ᴜᴅᴏ 𝗗ᴇ 𝗗ᴇɢᴀ", cache_time=0, alert=True)
