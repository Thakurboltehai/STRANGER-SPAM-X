...
PythonButton = [
        ...
        [
        Button.url("⚡️𝗖𝗛𝗔𝗡𝗡𝗘𝗟⚡️", "https://t.me/GROUPPPPPPPHELP"),
        Button.url("⚡️𝗦𝗨𝗣𝗣𝗢𝗥𝗧⚡️", "https://t.me/GROUPPPPPPPHELP")
        ],
        [
        Button.url("⚡️𝗥𝗘𝗣𝗢⚡️", "𝐝𝐦 𝐤𝐫 𝐛𝐡𝐚𝐢 𝐝𝐞𝐭𝐚 𝐡𝐮 ")
        ]
        ]
...
async def start(event):              
    if event.is_private:
        ...
        TEXT += f"» **✦ 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗗 𝗕𝗬 :~ [𝐑𝐈𝐒𝐇𝐀𝐍𝐓](https://t.me/oy_baby)**\n\n"
        TEXT += f"» **𝐑𝐈𝐒𝐇𝐀𝐍𝐓 𝗦𝗣𝗔𝗠 𝗩𝗘𝗥𝗦𝗜𝗢𝗡 :** `3.2`\n"
